...
%-----------------------------------------------------------------
\titleind{PENGEMBANGAN SISTEM \emph{SMART FARMING} APLIKASI TANAMAN ANDA (AMANDA) DENGAN BAHASA PEMROGRAMAN PYTHON DI PT. INAMAS SINTESIS TEKNOLOGI (INASTEK)}

\fullname{AIRLANGGA RASYAD FIDIYANTO}

\idnum{19/443562/TK/48758}
...
\firstsupervisor{Ir. Wahyu Dewanto, M.T.}
